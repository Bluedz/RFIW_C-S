...
public class ControlData {
    ...
    public static void main(String arg[]){
     if (amoutOfRFIDInExit == 9999) {
        ...
        System.out.println(ACSysIP01);
        System.out.println(ACSysIP02);
        System.out.println(ACSysLsnPort);
        System.out.println(ACSysCntPort);
        System.out.println(ACSysDevice01);
        System.out.println(ACSysDevice02);
        System.out.println(ACSysPSW);
        System.out.println(machineID);
        System.out.println(RFReadIP01);
        System.out.println(RFLsnPort);
        System.out.println(RFCntPort);
        System.out.println(RFIWVersion);
        System.out.println(configURI);
        
        URL confURI = Thread.currentThread().getContextClassLoader().getResource("");
        URL uri = new ControlData().getClass().getResource("");
        System.out.println(               confURI        );
        System.out.println(new ControlData().getClass().getResource(""));
